...
#warning TODO (alatar#1#): —делать диалог дл€ выбора типа входного файла, пока только P-CAD
...
//	dlg_save.SetFilename);
	...
	wxXmlDocument doc; //все ноды рекурсивно удал€ютс€ в деструкторе документа
...
// TODO (alatar#1#): ѕеренести в конструктор
